...
const SingUp: FC<SingUpProps> = ({handleSubmit, show}) => {
    ...
    return (
        <div className={`flex justify-between md:max-w-3xl lg:max-w-4xl bg-white rounded-3xl p-4 ${show && 'hidden'}`}>
            <div className="flex flex-col w-full md:w-1/2 p-6 py-12 items-center justify-center">
                <div className="space-y-6">
                    ...
                    <form onSubmit={submit} className="flex-1">
                        <div className="flex flex-col space-y-6">
                            ...
                            <button type="submit" className="bg-gray-900 text-white p-2 py-4 rounded-lg font-bold">
            ...
            <div>
                <img src={IllustrationDesktop} alt="Illustration Desktop" className="hidden md:flex" />
            </div>
        </div>
    );
};
